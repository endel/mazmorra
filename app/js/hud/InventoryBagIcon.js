export default class InventoryIcon extends THREE.Object3D {
  ...
  constructor () {
    ...
    this.scale.set(this.open.material.map.frame.w * HUD_SCALE, this.open.material.map.frame.h * HUD_SCALE, 1)

    this.width = this.open.material.map.frame.w * HUD_SCALE
    this.height = this.open.material.map.frame.h * HUD_SCALE
  }
